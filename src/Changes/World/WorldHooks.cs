...
public static class WorldHooks
{
    ...
    public static void Apply()
    {
        ...
        {
            orig(self);
            if (self.room != null && self.room.roomSettings.DangerType == DeadlandsEnums.DangerType.Desert || self.room.roomSettings.DangerType == DeadlandsEnums.DangerType.Sandstorm || self.room.roomSettings.DangerType == DeadlandsEnums.DangerType.DesertAndSandstorm)
            {
                string str = "\n\n";
    ...
    private static void OnRoomLoaded(On.Room.orig_Loaded orig, Room self)
    {
        ...
        {
            if (self.roomSettings.effects[i].type == DeadlandsEnums.RoomEffect.SunShade)
            {
                self.AddObject(new SunShade(self));
            }
        }
        if (self.roomSettings.DangerType == DeadlandsEnums.DangerType.Desert || self.roomSettings.DangerType == DeadlandsEnums.DangerType.Sandstorm || self.roomSettings.DangerType == DeadlandsEnums.DangerType.DesertAndSandstorm)
        {
