...
namespace Deadlands.Features.Weather
{
    /// <summary>
    /// Aiming for a combination between DustWave and BlizzardGraphics
    /// </summary>
    internal class Sandstorm : CosmeticSprite, IDrawable
    {
        ...
        //public static bool isDesertRegion(Region region) { return region != null && region.regionParams }
        public Sandstorm(RoomCamera rCam, float angle)
        {
            windAngle = angle;
            this.rCam = rCam;
        ...
        public override void InitiateSprites(RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam)
        {
            ...
            sLeaser.sprites[0].shader = room.game.rainWorld.Shaders[room.game.rainWorld.options.quality == Options.Quality.LOW ? "DustWaveLevelLow" : "DustWaveLevel"];
            ...
            sLeaser.sprites[1].scaleX = 150f;
            sLeaser.sprites[1].scaleY = 150f;
            sLeaser.sprites[1].shader = room.game.rainWorld.Shaders[room.game.rainWorld.options.quality == Options.Quality.LOW ? "DustWaveLevelLow" : "DustWaveLevel"];
            sLeaser.sprites[1].isVisible = mPos > 0f;
